...
export default function PnLAnalytics({
  ...
  return (
    ...
    <div className="overflow-hidden rounded-[28px] border border-white/[0.035] bg-[linear-gradient(180deg,rgba(10,18,32,0.98)_0%,rgba(4,10,18,1)_100%)] shadow-[0_0_40px_rgba(0,0,0,0.18)]">
      ...
      <div className="grid grid-cols-2 gap-10 px-14 pt-9 pb-8">

        {/* DAILY PNL */}

        <div className="rounded-[22px] border border-white/[0.03] bg-white/[0.015] pl-[84px] pr-12 pt-7 pb-10">
          ...
          <div className="relative h-[390px]">
            ...
            <div className="absolute left-[84px] right-[22px] top-[24px] bottom-[64px]">
            ...
            <div className="absolute left-[84px] right-[22px] top-[24px] bottom-[64px] flex gap-[8px]">
                ...
                (day, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className={`absolute left-1/2 w-[14px] -translate-x-1/2 rounded-[4px] transition-all duration-200 group-hover:w-[18px] ${
                          positive
            ...
            <div className="absolute bottom-0 left-[84px] right-[22px] flex gap-[8px]">
        ...
        <div className="rounded-[22px] border border-white/[0.03] bg-white/[0.015] px-12 pt-7 pb-10">
              ...
              {weekdayStats.map((day, index) => {
                ...
                return (
                  ...
                  <div key={day.day}>
                    ...
                    {/* INVISIBLE SEPARATOR BETWEEN DAYS */}
