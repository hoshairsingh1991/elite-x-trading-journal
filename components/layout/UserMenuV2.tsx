...
>
  ...
  />
      ...
      {isOpen && (
        <div className="absolute right-0 top-16 z-[99999] w-[500px] min-h-[818px] max-h-[80vh] overflow-y-auto rounded-[36px] border border-white/10 bg-[#071427] p-5 shadow-[0_40px_120px_rgba(0,0,0,0.85)]">
